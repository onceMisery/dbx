...
export default withEnglishFallback({
  ...
  editor: {
    ...
    connectionOnlyTarget: "接続レベルターゲット",
  },
  tabs: {
    sql: "SQL",
    table: "テーブル",
  ...
  exportProgress: {
    ...
    multiDbExecutionTitle: "複数DB実行：{name}",
  ...
  multiDbExecute: {
    title: "複数DB実行",
    progress: "実行進捗（{completed}/{total}）",
    sqlPreview: "SQL プレビュー",
    databaseType: "データベースタイプ",
    searchTargets: "接続、データベース、Schemaを検索...",
    selectedCount: "選択済み {count} 件のターゲット",
    selectedTargets: "選択済み実行ターゲット",
    selectGroup: "SQL実行ターゲットグループ",
    noGroupSelected: "ターゲットグループを選択",
    manageGroups: "ターゲットグループを管理",
    manageGroupsDescription: "ターゲットグループはSQL実行ターゲットを再利用するためのもので、接続グループは変更されません。",
    noGroups: "ターゲットグループがありません",
    loadGroup: "ターゲットグループを読み込む",
    available: "利用可能",
    typeMismatch: "タイプ不一致",
    targets: "件のターゲット",
    saveAsGroup: "ターゲットグループとして保存",
    saveChanges: "変更を保存",
    saveAsNewGroup: "新しいターゲットグループとして保存",
    renameGroup: "ターゲットグループ名を変更",
    deleteGroup: "ターゲットグループを削除",
    deleteGroupConfirm: "ターゲットグループ「{name}」を削除しますか？接続とデータベース設定には影響しません。",
    groupName: "ターゲットグループ名",
    groupNameRequired: "ターゲットグループ名を入力してください。",
    groupNameExists: "ターゲットグループ名は既に存在します。",
    groupSaved: "ターゲットグループが保存されました",
    groupSaveFailed: "ターゲットグループの保存に失敗しました：{message}",
    groupLoadFailed: "ターゲットグループの読み込みに失敗しました：{message}",
    groupModified: "ターゲット選択が変更されました",
    unsavedChangesConfirm: "現在のターゲット選択には未保存の変更があります。保存してから続行しますか？",
    ...
    validTarget: "ターゲットは有効",
    needsRecheck: "ターゲット検証待ち",
    needsRecheckCount: "検証待ちのターゲットが {count} 件あります",
    invalidTargetCount: "無効なターゲットが {count} 件あります",
    invalidTarget: "ターゲットが無効",
    targetMissingConnection: "接続が存在しません",
    targetTypeMismatch: "接続のデータベースタイプが一致しません",
    targetCatalogMissing: "Catalogが存在しません",
    targetDatabaseMissing: "データベースが存在しないか、アクセス権がありません",
    targetSchemaMissing: "Schemaが存在しないか、アクセス権がありません",
    targetPermissionDenied: "ターゲット検証中に権限が不足しています",
    targetValidationFailed: "ターゲット検証に失敗しました",
    retryValidation: "検証を再試行",
    serialContinueOnError: "直列実行、失敗後も続行",
    parallelContinueOnError: "並列実行、失敗後も続行",
    serial: "直列",
    parallel: "並列",
