...
export default withEnglishFallback({
  ...
  exportProgress: {
    ...
    multiDbExecutionTitle: "Execução em múltiplos bancos: {name}",
  ...
  production: {
    ...
    sourceMultiDbSql: "Execução SQL em múltiplos bancos",
  },
  processList: {
  ...
  multiDbExecute: {
    title: "Execução em múltiplos bancos",
    progress: "Progresso da execução ({completed}/{total})",
    sqlPreview: "Pré-visualização de SQL",
    databaseType: "Tipo de banco de dados",
    searchTargets: "Pesquisar conexões, bancos de dados, Schema...",
    selectedCount: "{count} destinos selecionados",
    selectedTargets: "Destinos de execução selecionados",
    selectGroup: "Grupo de destinos de execução SQL",
    noGroupSelected: "Selecione o grupo de destinos",
    manageGroups: "Gerenciar grupos de destinos",
    manageGroupsDescription: "Os grupos de destinos são usados para reutilizar destinos de execução SQL e não alteram o agrupamento de conexões.",
    noGroups: "Nenhum grupo de destinos",
    loadGroup: "Carregar grupo de destinos",
    available: "Disponível",
    typeMismatch: "Incompatibilidade de tipo",
    targets: "destinos",
    saveAsGroup: "Salvar como grupo de destinos",
    saveChanges: "Salvar alterações",
    saveAsNewGroup: "Salvar como novo grupo de destinos",
    renameGroup: "Renomear grupo de destinos",
    deleteGroup: "Excluir grupo de destinos",
    deleteGroupConfirm: "Tem certeza de que deseja excluir o grupo de destinos “{name}”? Isso não afetará as conexões e a configuração do banco de dados.",
    groupName: "Nome do grupo de destinos",
    groupNameRequired: "Por favor, insira o nome do grupo de destinos.",
    groupNameExists: "O nome do grupo de destinos já existe.",
    groupSaved: "Grupo de destinos salvo.",
    groupSaveFailed: "Falha ao salvar o grupo de destinos: {message}",
    groupLoadFailed: "Falha ao carregar o grupo de destinos: {message}",
    groupModified: "A seleção de destinos foi modificada.",
    unsavedChangesConfirm: "Há alterações não salvas na seleção atual de destinos. Deseja salvá-las antes de continuar?",
    cancelOperation: "Cancelar operação",
    discardChanges: "Descartar alterações",
    internalCatalog: "Interno",
    defaultDatabase: "Banco de dados padrão",
    noDatabase: "Execução no nível da conexão",
    clearTargets: "Limpar",
    noTargets: "Não há destinos executáveis.",
    removeTarget: "Remover destino",
    validTarget: "Destino válido",
    needsRecheck: "Aguardando validação",
    needsRecheckCount: "Há {count} destinos aguardando validação",
    invalidTargetCount: "Há {count} destinos inválidos",
    invalidTarget: "Destino inválido",
    targetMissingConnection: "A conexão não existe mais.",
    targetTypeMismatch: "O tipo do banco de dados da conexão não corresponde mais.",
    targetCatalogMissing: "O catálogo não existe mais.",
    targetDatabaseMissing: "O banco de dados não existe ou você não tem acesso a ele.",
    targetSchemaMissing: "O Schema não existe ou você não tem acesso a ele.",
    targetPermissionDenied: "Permissão insuficiente ao validar o destino.",
    targetValidationFailed: "Falha na validação do destino.",
    retryValidation: "Repetir validação",
    serialContinueOnError: "Execução sequencial, continuar após erro",
    parallelContinueOnError: "Execução em paralelo, continuar após erro",
    serial: "Sequencial",
    parallel: "Paralelo",
    switchToParallel: "Alternar para paralelo",
    switchToSerial: "Alternar para sequencial",
    elapsed: "Tempo decorrido: {duration}",
    pending: "Pendente",
    running: "Em execução",
    success: "Sucesso",
