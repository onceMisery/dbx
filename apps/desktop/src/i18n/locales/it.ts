...
export default withEnglishFallback({
  ...
  exportProgress: {
    ...
    multiDbExecutionTitle: "Esecuzione multi-DB: {name}",
    multiDbTargets: "Target {completed}/{total}, riusciti {success}, non riusciti {failed}",
  ...
  multiDbExecute: {
    title: "Esecuzione multi-DB",
    progress: "Avanzamento esecuzione ({completed}/{total})",
    sqlPreview: "Anteprima SQL",
    databaseType: "Tipo di database",
    searchTargets: "Cerca connessioni, database, Schema...",
    selectedCount: "Selezionati {count} target",
    selectedTargets: "Target di esecuzione selezionati",
    selectGroup: "Seleziona gruppo di target",
    noGroupSelected: "Seleziona gruppo di target",
    manageGroups: "Gestisci gruppi di target",
    manageGroupsDescription: "I gruppi di target vengono utilizzati per riutilizzare i target di esecuzione SQL e non modificano i gruppi di connessione.",
    noGroups: "Nessun gruppo di target",
    loadGroup: "Carica gruppo di target",
    available: "Disponibile",
    typeMismatch: "Tipo non corrispondente",
    targets: "target",
    saveAsGroup: "Salva come gruppo di target",
    saveChanges: "Salva modifiche",
    saveAsNewGroup: "Salva come nuovo gruppo di target",
    renameGroup: "Rinomina gruppo di target",
    deleteGroup: "Elimina gruppo di target",
    deleteGroupConfirm: "Sicuro di eliminare il gruppo di target “{name}”? Non influirà sulle connessioni e sulle configurazioni del database.",
    groupName: "Nome del gruppo di target",
    groupNameRequired: "Inserisci il nome del gruppo di target.",
    groupNameExists: "Il nome del gruppo di target esiste già.",
    groupSaved: "Gruppo di target salvato",
    groupSaveFailed: "Salvataggio del gruppo di target non riuscito: {message}",
    groupLoadFailed: "Caricamento del gruppo di target non riuscito: {message}",
    groupModified: "La selezione dei target è stata modificata",
    unsavedChangesConfirm: "La selezione dei target corrente contiene modifiche non salvate. Vuoi salvare prima di continuare?",
    ...
    noDatabase: "Esecuzione a livello di connessione",
    clearTargets: "Svuota",
    noTargets: "Nessun target da eseguire.",
    removeTarget: "Rimuovi target",
    validTarget: "Target valido",
    needsRecheck: "In attesa di verifica",
    needsRecheckCount: "{count} target in attesa di verifica",
    invalidTargetCount: "{count} target non validi",
    invalidTarget: "Target non valido",
    targetMissingConnection: "Connessione non più esistente",
    targetTypeMismatch: "Il tipo di database della connessione non corrisponde più",
    targetCatalogMissing: "Catalog non più esistente",
    targetDatabaseMissing: "Database inesistente o accesso non autorizzato",
    targetSchemaMissing: "Schema inesistente o accesso non autorizzato",
    targetPermissionDenied: "Permessi insufficienti durante la verifica del target",
    targetValidationFailed: "Verifica del target non riuscita",
    retryValidation: "Riprova verifica",
    serialContinueOnError: "Esecuzione seriale, continua dopo l'errore",
    parallelContinueOnError: "Esecuzione parallela, continua dopo l'errore",
    serial: "Seriale",
    parallel: "Parallelo",
    switchToParallel: "Passa a parallelo",
    ...
    dangerTitle: "Conferma esecuzione target",
    dangerConfirm: "Esegui su questo target",
