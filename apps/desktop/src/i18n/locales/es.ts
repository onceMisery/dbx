...
export default withEnglishFallback({
  ...
  exportProgress: {
    ...
    multiDbExecutionTitle: "Ejecución multi-base de datos: {name}",
    multiDbTargets: "Objetivos {completed}/{total}, exitosos {success}, fallidos {failed}",
  ...
  multiDbExecute: {
    title: "Ejecución multi-base de datos",
    progress: "Progreso de ejecución ({completed}/{total})",
    sqlPreview: "Vista previa de SQL",
    databaseType: "Tipo de base de datos",
    searchTargets: "Buscar conexión, base de datos, esquema...",
    selectedCount: "{count} objetivos seleccionados",
    selectedTargets: "Objetivos de ejecución seleccionados",
    selectGroup: "Grupo de objetivos de ejecución SQL",
    noGroupSelected: "Seleccionar grupo de objetivos",
    manageGroups: "Administrar grupos de objetivos",
    manageGroupsDescription: "Los grupos de objetivos se utilizan para reutilizar los objetivos de ejecución SQL y no cambian la agrupación de conexiones.",
    noGroups: "No hay grupos de objetivos",
    loadGroup: "Cargar grupo de objetivos",
    available: "Disponible",
    typeMismatch: "Tipo no coincide",
    targets: "objetivos",
    saveAsGroup: "Guardar como grupo de objetivos",
    saveChanges: "Guardar cambios",
    saveAsNewGroup: "Guardar como nuevo grupo de objetivos",
    renameGroup: "Renombrar grupo de objetivos",
    deleteGroup: "Eliminar grupo de objetivos",
    deleteGroupConfirm: "¿Seguro que deseas eliminar el grupo de objetivos \"{name}\"? Esto no afectará las conexiones ni la configuración de la base de datos.",
    groupName: "Nombre del grupo de objetivos",
    groupNameRequired: "Ingrese el nombre del grupo de objetivos.",
    groupNameExists: "El nombre del grupo de objetivos ya existe.",
    groupSaved: "Grupo de objetivos guardado.",
    groupSaveFailed: "Error al guardar el grupo de objetivos: {message}",
    groupLoadFailed: "Error al cargar el grupo de objetivos: {message}",
    groupModified: "La selección de objetivos ha sido modificada.",
    unsavedChangesConfirm: "La selección de objetivos actual tiene cambios sin guardar. ¿Desea guardar los cambios antes de continuar?",
    cancelOperation: "Cancelar operación",
    discardChanges: "Descartar cambios",
    internalCatalog: "Interno",
    defaultDatabase: "Base de datos predeterminada",
    noDatabase: "Ejecución a nivel de conexión",
    clearTargets: "Limpiar",
    noTargets: "No hay objetivos de ejecución.",
    removeTarget: "Eliminar objetivo",
    validTarget: "Objetivo válido",
    needsRecheck: "Necesita verificación",
    needsRecheckCount: "Hay {count} objetivos pendientes de verificación",
    invalidTargetCount: "Hay {count} objetivos no válidos",
    ...
    targetDatabaseMissing: "La base de datos no existe o no tiene permisos de acceso",
    targetSchemaMissing: "El esquema ya no existe",
    targetPermissionDenied: "Permisos insuficientes al verificar el objetivo",
    targetValidationFailed: "Falló la verificación del objetivo",
    retryValidation: "Reintentar verificación",
    serialContinueOnError: "Ejecución en serie, continuar después del error",
    parallelContinueOnError: "Ejecución en paralelo, continuar después del error",
    serial: "Serial",
    parallel: "Paralelo",
    switchToParallel: "Cambiar a paralelo",
    switchToSerial: "Cambiar a serial",
    ...
    dangerTitle: "Confirmar ejecución de objetivos",
    dangerConfirm: "Ejecutar en este objetivo",
