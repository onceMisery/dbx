...
export default withEnglishFallback({
  ...
  exportProgress: {
    ...
    multiDbExecutionTitle: "多庫執行：{name}",
  ...
  multiDbExecute: {
    ...
    sqlPreview: "SQL 預覽",
    databaseType: "資料庫類型",
    searchTargets: "搜尋連線、資料庫、Schema...",
    selectedCount: "已選擇 {count} 個目標",
    selectedTargets: "已選執行目標",
    selectGroup: "SQL 執行目標組",
    noGroupSelected: "選擇目標組",
    manageGroups: "管理目標組",
    manageGroupsDescription: "目標組用於重複使用 SQL 執行目標，不會變更連線分組。",
    noGroups: "暫無目標組",
    loadGroup: "載入目標組",
    available: "可用",
    typeMismatch: "類型不匹配",
    ...
    saveAsGroup: "儲存為目標組",
    saveChanges: "儲存修改",
    saveAsNewGroup: "另存為新目標組",
    renameGroup: "重新命名目標組",
    deleteGroup: "刪除目標組",
    deleteGroupConfirm: "確定刪除目標組「{name}」嗎？不會影響連線和資料庫組態。",
    groupName: "目標組名稱",
    groupNameRequired: "請輸入目標組名稱。",
    groupNameExists: "目標組名稱已存在。",
    groupSaved: "目標組已儲存",
    groupSaveFailed: "儲存目標組失敗：{message}",
    groupLoadFailed: "載入目標組失敗：{message}",
    groupModified: "目標選擇已修改",
    unsavedChangesConfirm: "目前目標選擇有未儲存修改，是否先儲存後繼續？",
    ...
    validTarget: "目標有效",
    needsRecheck: "等待目標校驗",
    needsRecheckCount: "有 {count} 個目標待校驗",
    invalidTargetCount: "有 {count} 個目標失效",
    invalidTarget: "目標失效",
    targetMissingConnection: "連線已不存在",
    targetTypeMismatch: "連線資料庫類型已不匹配",
    targetCatalogMissing: "Catalog 已不存在",
    targetDatabaseMissing: "資料庫不存在或無權存取",
    targetSchemaMissing: "Schema 不存在或無權存取",
    targetPermissionDenied: "校驗目標時權限不足",
    targetValidationFailed: "目標校驗失敗",
    retryValidation: "重試校驗",
