...
export const SETTINGS_SEARCH_DEFINITIONS: readonly SettingsSearchDefinition[] = [
  ...
  { id: "data-metadata-cache", category: "data", titleKey: "settings.metadataCacheMemoryLimit", descriptionKey: "settings.metadataCacheMemoryLimitDescription", targetId: "data" },
